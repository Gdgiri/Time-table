...
const timetableData = [
  ...
  {
    time: "8:00 - 8:30 AM",
    activity: "Morning Routine (Coffee, Food, Bath, Pray)",
  },
  {
    time: "8:30 - 9:00 AM",
    activity: "Study Session 1 (Focus on which you are in Weak concepts)",
  },
  {
    time: "9:00 - 10:00 AM",
    activity: "Study Session 2 (Problem Solving/Practice)",
  },
  { time: "10:00 AM - 1:00 PM", activity: "Online Class" },
  { time: "1:00 - 1:30 PM", activity: "Lunch Break" },
  {
    time: "1:30 - 2:30 PM",
    activity: "Project Work (Learn new like firebasr,socket.io..etc)",
  },
  { time: "2:30 - 3:00 PM", activity: "Break/Rest" },
  { time: "3:00 - 4:00 PM", activity: "Study Session 3 (Interview MERN)" },
  { time: "4:00 - 4:30 PM", activity: "Workout" },
  { time: "4:30 - 5:00 PM", activity: "Afternoon Break (Coffee, Relax)" },
  {
    time: "5:00 - 6:30 PM",
    activity: "Study Session 4 (Problem Solving Practice)",
  },
  { time: "6:30 - 7:00 PM", activity: "Dinner/Evening Meal" },
  {
    time: "7:00 - 9:00 PM",
    activity: "Project Work (Focus on finalizing tasks)",
  },
